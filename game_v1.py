...
length = 500/level# ao escolher o nivel do jogo, o programa retorna um tamanho de barra, logo, quanto maior o nivel do jogo menor o tamanho de barra
...
#Esse bloco está definindo a ação das bolas
class Bola:
...
#Esse bloco ddfine a ação da barra
class Barra:
